...
public class MediaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.recyclerView_instaGalary);

        ArrayList<InstaGalary> list = MainActivity.getMainActivity().retrieveImages();
        GalaryAdapter adapter = new GalaryAdapter(list);
